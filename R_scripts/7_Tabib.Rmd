...
---
```{r}
Tabib <- readRDS("../Input/Tabib_SeuratObject_AD23-Clusters (1).rds")
...
barplot(percentages$DS2D, names=v, cex.names=0.7, col="darkblue", main="Percentage of predicted deeply senescent cells",
