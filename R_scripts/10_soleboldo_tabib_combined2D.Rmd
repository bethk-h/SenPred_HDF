---
title: "Soleboldo_tabib_combined2"
author: "BH"
date: "2024-03-09"
...
seurat_integrated <- FindVariableFeatures(seurat_integrated, selection.method ="vst", nfeatures=18000)
...
```
##Finding percentage prediction for each donor age
```{r}
