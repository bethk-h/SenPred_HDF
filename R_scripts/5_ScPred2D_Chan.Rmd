...
png(filename = "../Output/Chan/scPred2D_Chan_barplot.png", width = 800, height = 600)  # Set appropriate width and height
...
barplot(percentages$DS2D, names=v, cex.names=0.7, col="darkblue", main="Percentage of predicted senescent cells",
...
FeaturePlot(query, features = c("CDKN1A", "CDKN2A"))     
ggsave(
  "pdl50_cdkn1a_cdkn2a.tiff",
  plot = last_plot(),
  device = "tiff",
  path = "../Output/Chan"
  )
