...
png(filename = "../Output/SoleBoldo/scPred3D_barplot_DS3Dbycluster.png", width = 800, height = 600)  # Set appropriate width and height
...
png(filename = "../Output/Tabib/scPred3D_barplot_DS3Dbycellidentity.png", width = 800, height = 600)  # Set appropriate width and height
