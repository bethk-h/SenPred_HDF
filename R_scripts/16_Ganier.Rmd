...
# Define a function for further analysis on processed Seurat objects
analyze_seurat_object <- function(seurat_object, output_path = "../Output/Ganier") {
  age <- seurat_object@meta.data$age[1]
  ...
  ggsave(file.path(output_path, paste0("HDF_2D_variablefeatures_", age, ".tiff")),
  ...
  ggsave(file.path(output_path, paste0("UMAP_HDF_2D_", age, ".tiff")),
  ...
  write.csv(seurat_markers, file.path(output_path, paste0("HDF2D_clustermarkers_posandneg_", age, ".csv")))
  ...
  saveRDS(seurat_object, file = file.path(output_path, paste0("hdfseuratfiltered_2Dcells_", age, ".rds")))
}

# Apply the function to your list of processed Seurat objects
...
# Define the modified analysis function
analyze_seurat_objects <- function(Ganier_list) {
  for (i in seq_along(Ganier_list)) {
    Gan_object <- Ganier_list[[i]]
    
    # Extract age
    age <- Gan_object@meta.data$age[1]
    ...
    ggsave(
      paste0("variable_features_", names(Ganier_list)[i], "_Age_", age, ".tiff"),
      plot = last_plot(),
      device = "tiff",
      path = "../Output/Ganier",
    ...
    # Save PCA Plot
    ggsave(
      paste0("PCA_no_label_", names(Ganier_list)[i], "_Age_", age, ".tiff"),
      plot = PCA_no_label,
      device = "tiff",
      path = "../Output/Ganier",
      width = 15,  # adjust as needed
    ...
    # Save UMAP Plot
    ggsave(
      paste0("UMAP_Ganier_", names(Ganier_list)[i], "_Age_", age, ".tiff"),
      plot = last_plot(),
      device = "tiff",
      path = "../Output/Ganier",
      width = 15,  # adjust as needed
    ...
    # Save DotPlot
    ggsave(
      paste0("DotPlot_Ganier_", names(Ganier_list)[i], "_Age_", age, ".tiff"),
      plot = last_plot(),
      device = "tiff",
      path = "../Output/Ganier",
      width = 15,  # adjust as needed
...
# Assuming you have already created and populated Ganier_list
# For example, Ganier_list <- list(seurat_object1, seurat_object2, seurat_object3)

# Run the modified analysis function
analyze_seurat_objects(Ganier_list)
