...
draw_confusion_matrix <- function(cm, output_file) {
  ...
  title('MDA Confusion Matrix (%)', cex.main=1.5)

  # create the matrix 
  rect(150, 420, 200, 360, col='#32CD32')
  text(175, 440, 'DS', cex=1.2)
  rect(205, 420, 255, 360, col='#FF4500')
  text(230, 440, 'EP', cex=1.2)
  rect(260, 420, 310, 360, col='#FF4500')
  text(285, 440, 'ES', cex=1.2)
  
  text(125, 325, 'Predicted', cex=1.3, srt=90, font=2)
  text(230, 465, 'Actual', cex=1.3, font=2)
  rect(150, 290, 200, 350, col='#FF4500')
  rect(205, 290, 255, 350, col='#32CD32')
  text(140, 390, 'DS', cex=1.2, srt=90)
  text(140, 320, 'EP', cex=1.2, srt=90)
  ...
  text(140, 250, 'ES', cex=1.2, srt=90)
  ...
  text(176, 393, res[1], cex=1.2, font=2, col='white')
  text(176, 323, res[2], cex=1.2, font=2, col='white')
  text(176, 253, res[3], cex=1.2, font=2, col='white')
  text(230, 393, res[4], cex=1.2, font=2, col='white')
  text(230, 323, res[5], cex=1.2, font=2, col='white')
  text(230, 253, res[6], cex=1.2, font=2, col='white')
  text(284, 393, res[7], cex=1.2, font=2, col='white')
  text(284, 323, res[8], cex=1.2, font=2, col='white')
  text(284, 253, res[9], cex=1.2, font=2, col='white')
  text(120, 200, 'Unassigned =', cex=0.9, font=1, col='black')
  text(155, 201, unassigned, cex=0.9, font=1, col='black')
}
...
output_file_path <- "../Output/Early_senescence/CM2D_SVM_testing.png"
...
barplot(barplot_data, names = barplot_names, cex.names = 0.7, col = "darkblue", main = "Percentage of predicted early senescent cells",
