...
seurat_integrated_3D <- FindVariableFeatures(seurat_integrated_3D, selection.method ="vst", nfeatures=18000)
...
```
## Generating a correlation matrix of a panel of selected senescence genes
```{r}
...
ggsave(
  "Markercorrelation_DS_tabibsole.tiff",
  plot = last_plot(),
  device = "tiff",
  path = "../Output/TabibSole_Integrated"
  )
...
```
## Generating a correlation matrix of a panel of selected senescence genes - EP
```{r}
# Subset the Seurat object based on scpred_prediction
filtered_seurat_EP <- subset(seurat_integrated_3D, subset = scpred_prediction == "EP3D")

# Extract gene counts for filtered cells
gene_counts <- filtered_seurat_EP@assays$RNA@counts
...
ggsave(
  "Markercorrelation_EP_tabibsole.tiff",
  plot = last_plot(),
  device = "tiff",
  path = "../Output/TabibSole_Integrated"
  )
...
CDKN1A_counts <- filtered_seurat@assays$RNA@counts["CDKN1A", ]
CDKN2A_counts <- filtered_seurat@assays$RNA@counts["CDKN2A", ]
...
# Extract counts for CDKN1A and CDKN2A from Seurat object - DS only
CDKN1A_counts <- filtered_seurat_EP@assays$RNA@counts["CDKN1A", ]
CDKN2A_counts <- filtered_seurat_EP@assays$RNA@counts["CDKN2A", ]
...
IL6_counts <- filtered_seurat@assays$RNA@counts["IL6", ]
IL8_counts <- filtered_seurat@assays$RNA@counts["IL8", ]
...
IL6_counts <- filtered_seurat_EP@assays$RNA@counts["IL6", ]
IL8_counts <- filtered_seurat_EP@assays$RNA@counts["IL8", ]
...
IGFBP3_counts <- filtered_seurat@assays$RNA@counts["IGFBP3", ]
TP53_counts <- filtered_seurat@assays$RNA@counts["TP53", ]
...
IGFBP3_counts <- filtered_seurat_EP@assays$RNA@counts["IGFBP3", ]
TP53_counts <- filtered_seurat_EP@assays$RNA@counts["TP53", ]
