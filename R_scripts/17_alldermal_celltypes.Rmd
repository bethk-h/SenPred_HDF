...
#MDA radial model
queryGanier <- NormalizeData(Ganier_integrated)
...
write.csv(percentages_Ganier3D, "../Output/GanierALL/EPDS3D_ganierall.csv")
...
#Combining Tabib, Sole, and Ganier predictions for scatterplot - 3D ALL

```{r}
Tabib <- read.csv("../Output/Tabib/EPDS3D_tabibALL.csv")
Sole <- read.csv("../Output/SoleBoldoALL/EPDS3D_soleall.csv")
Ganier <- read.csv("../Output/GanierALL/EPDS3D_ganierall.csv")
...
ggsave(
  "scatterplot_3DALL_TabibGanierSole.tiff",
  plot = last_plot(),
  device = "tiff",
  path = "../Output"
  )
